...
အဲ့ဒါကို စကားအဆက်အစပ်လွတ်သွားတယ်လို့ခေါ်ပါတယ်<br>
တစ်ဖက်က "EV ကား" အကြောင်းပြောနေတဲ့အချိန် ကိုယ့်ဘက်ကလည်း<br>
ကားအကြောင်းနဲ့ဆက်စပ်တဲ့ စကားကိုပြန်ပြောရမှာပါ<br>
...
- juypter notebook သုံးသူတွေက အောက်မှာပြထားတဲ့ code block အတိုင်း cellတစ်ခုချင်းစီ runရမှာဖြစ်ပြီး
- pyCharm သုံးသူတွေကတော့ codeအကုန် ရိုက်ပြီးမှ တစ်ခါတည်း run ရမှာပါ
...
- model တွေဟာ စွမ်းဆောင်ရည်မတူတဲ့အတွက် ဘယ် modelက အချိန်ဘယ်လောက်ယူမလဲဆိုတာ<br>ပျှမ်းမျှအားဖြင့်သိသွားစေပါတယ်
- ဒါကြောင့် ကိုယ်က မြန်မြန်သုံးချင်ရင် ဘယ် model,<br>
ပိုပြီး reasoning ဖြစ်ချင်ရင် ဘယ် modelအစရှိသဖြင့် သိသွားစေမှာပါ
